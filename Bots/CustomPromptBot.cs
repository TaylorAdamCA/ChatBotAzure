...
namespace PromptUsersForInput.Bots
{
    public class CustomPromptBot : ActivityHandler
    {
        ...
        public CustomPromptBot(BotState conversationState, BotState userState)
        {
        ...
        /*
                    ...
                    CancellationToken cancellationToken)
                {
                    ...
                    var flow = await conversationStateAccessors.GetAsync(turnContext, () => new ServerRecipientActivitiesFlow());
                    ...
                    switch (flow.LastQuestionAsked)
                    {
                        ...
                        case ServerRecipientActivitiesFlow.Question.NonFTFAssessment:
                            if (ValidateResponse(input, out int NonFTFResponse, out message, 0, 1))
                            {
                                ...
                                await SuggestionActions.SendIntSuggestionsActionsAsync(turnContext, CancellationToken.None, "Face To Face Assessment", new List<int>() { 0, 1 });
                        ...
                        case ServerRecipientActivitiesFlow.Question.FTFAssessment:
                            if (ValidateResponse(input, out int FTFResponse, out message, 0, 1))
                            {
                                ...
                                await SuggestionActions.SendIntSuggestionsActionsAsync(turnContext, CancellationToken.None, "Telephone / Electronic Assessment", new List<int>() { 0, 1 });
                        ...
                        case ServerRecipientActivitiesFlow.Question.TelephoneElectronicAssessment:
                            ...
                            {
                                serverRecipientActivities.Assessment.TelephoneElectronicAssessment = telephoneElectronicResponse;
                                await SuggestionActions.SendIntSuggestionsActionsAsync(turnContext, CancellationToken.None, "Telephone / Electronic Implement / Evaluate Plan", new List<int>() { 0, 1 });
                        ...
                        case ServerRecipientActivitiesFlow.Question.TelephoneElectronicEvaluate:
                            ...
                            {
                                serverRecipientActivities.Assessment.TelephoneElectronicPlan = telephoneElectronicEvaluateResponse;
                                await SuggestionActions.SendIntSuggestionsActionsAsync(turnContext, CancellationToken.None, "THERAPEUTIC INTERVENTION \n" +
                        ...
                        case ServerRecipientActivitiesFlow.Question.GroupPatientTeaching60:
                            if (ValidateResponse(input, out int groupPatientTeaching60Response, out message, 0, 1))
                            {
                                serverRecipientActivities.TherapeuticIntervention.GroupPatientTeaching60Minutes = groupPatientTeaching60Response;
                                await SuggestionActions.SendIntSuggestionsActionsAsync(turnContext, CancellationToken.None, "Group Patient Teaching: 69 Minutes", new List<int>() { 1, 90 });
                        ...
                        case ServerRecipientActivitiesFlow.Question.GroupPatientTeaching90:
                            if (ValidateResponse(input, out int groupPatientTeaching90Response, out message, 0, 1))
                            {
                                serverRecipientActivities.TherapeuticIntervention.GroupPatientTeaching90Minutes = groupPatientTeaching90Response;
                                await turnContext.SendActivityAsync($"Non Face To Face Assessment / Develop Plan {serverRecipientActivities.Assessment.NonFTFAssessment}.");
                                await turnContext.SendActivityAsync($"Face To Face Assessment {serverRecipientActivities.Assessment.FTFAssessment}.");
                                await turnContext.SendActivityAsync($"Telephone / Electronic Assessment {serverRecipientActivities.Assessment.TelephoneElectronicAssessment}.");
                                await turnContext.SendActivityAsync($"Telephone / Electronic Implement / Evaluate Plan {serverRecipientActivities.Assessment.TelephoneElectronicPlan}.");
                                await turnContext.SendActivityAsync($"Group Patient Teaching: 60 Minutes {serverRecipientActivities.TherapeuticIntervention.GroupPatientTeaching60Minutes}.");
                                await turnContext.SendActivityAsync($"Group Patient Teaching: 90 Minutes {serverRecipientActivities.TherapeuticIntervention.GroupPatientTeaching90Minutes}.");
                ...
                private static bool ValidateResponse(string input, out int response, out string message, int lowerBoundInclusive, int upperBoundInclusive)
                {
                    response = 0;
                    message = null;
                    ...
                    {
                        message = "I'm sorry, I could not interpret that as a number. Please enter a number between " + lowerBoundInclusive + " and " + upperBoundInclusive + ".";
                    }
